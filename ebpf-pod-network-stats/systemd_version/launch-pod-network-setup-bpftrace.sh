...
bpftrace --unsafe -e 'uretprobe:/usr/bin/containerd:"github.com/containerd/containerd/pkg/cri/server.(*criService).setupPodNetwork" { system("./attach_ebpf_stats_prog.sh %d", retval); }'
